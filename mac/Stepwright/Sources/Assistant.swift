...
enum Assistant {
    ...
    A value that was typed is not always a value the reader should type. Keep it exactly \
    when it belongs to the task and the reader must enter the same thing: an address, a \
    command, a setting, a search, the name of something already in the system. When it was \
    the person's own particulars, tell the reader to enter their own rather than copying \
    someone else's: a name, a date of birth, an email address they are choosing, a phone \
    number, a password. Name the field either way.
