...
public static class AiShaper
{
    ...
    private const string Rules =
        ...
        + "pressing Enter is one step. Filling in the fields of one form is one step, whether "
        + "they were typed or chosen from a list: give every field and every value in the order "
        + "they were filled, and fold the button that submits the form in with them.\n"
        + "A step whose only content is a key that moved between fields, such as Tab, belongs "
        + "with the typing on either side of it rather than standing on its own.\n"
        ...
        + "or what they should expect to happen. Leave it empty when the step speaks for "
        + "itself. Never restate the step, and never write a note about the guide or about how "
        + "it was recorded, such as saying that a value was hidden. "
